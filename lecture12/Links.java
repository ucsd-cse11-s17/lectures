/* An interface to a list of strings.  We will implement
   this interface so that we never _change_ existing
   StringLists, only create new ones (this can be useful
   practically, and will help us out pedagogically). */
